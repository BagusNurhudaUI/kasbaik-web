...
const Footer = () => {
    ...
    return (
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <li>
                <a href="https://kasbaik.kitabisa.com" className="hover:text-gray-400">
                About
                </a>
            </li>
            </ul>
        ...
        <span className="block text-sm text-white sm:text-center dark:text-white">
            © 2022{" "}
            <a href="https://kitabisa.com" className="hover:underline">
            Kitabisa
            </a>
            . Made by <a href='https://instagram.com/bagusnurhuda' className='hover:text-gray-400' target='_blank'>Bagus Nurhuda</a>
        </span>
            </footer>
        </div>
